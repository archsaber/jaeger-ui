...
export function submitForm(fields, fetchAlerts) {
  const {
    startDate,
    startDateTime,
    endDate,
...
export const statSideBarFormSelector = formValueSelector('alertSideBar');
...
function mapDispatchToProps(dispatch) {
  const { fetchAlerts } = bindActionCreators(jaegerApiActions, dispatch);
  return {
    onSubmit: fields => submitForm(fields, fetchAlerts),
  };
}
